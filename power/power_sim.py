...
COHORTS = [PERIOD_2024H1] * 5 + [PERIOD_2024H1 + 2] * 5 + [PERIOD_2024H1 + 4] * 4 + [np.inf] * 6
SD_UNIT_PERIOD, SD_PASSAGE = 0.15, float(np.hypot(0.5, 0.4))
N_PERM, N_REP = 199, 250
LAMBDAS = [0.25, 0.5, 1.0, 2.0, 4.0]
BETAS = [0.0, 0.1, 0.2, 0.3, 0.45, 0.6]
...
df.to_csv("power_grid.csv", index=False)
